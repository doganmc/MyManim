...
class D_TABLE_ENG(Scene):
        ...
        #SHOW TEMPLATE POLYNOM AND ZIG ZAG PATTERN FIRST
                ...
                self.play(  FadeToColor( poly1[1],BLUE_C ), FadeToColor( poly1[4],BLUE_C ),
                            FadeToColor( poly1[7],YELLOW_C ), FadeToColor( poly1[10],YELLOW_C ),
        ...
        #START TO CREATE THE ROUTH ARRAY
                ...
                crl1 = Line(start=col1[0], end=col2[1],buff=0.1).set_color(YELLOW_D)
                crl2 = Line(start=col1[1], end=col2[0],buff=0.1).set_color(BLUE_D)
    ...
    # CALCULATE THE REST OF THE TABLE
        ...
        # SHOW b1
                ...
                self.play(  FadeToColor(b1[0],YELLOW_D),
                            FadeToColor(b1[1],WHITE),
                            FadeToColor(b1[2],BLUE_D),
                            FadeToColor(b1[3],WHITE),
                            FadeToColor(b1[4],BLUE_D),

                            FadeToColor(col1[0],YELLOW_D),FadeToColor(col2[0],BLUE_D),
                            FadeToColor(col1[1],BLUE_D),  FadeToColor(col2[1],YELLOW_D),
                        )
        ...
        # SHOW b2
                ...
                crl1.target.become( Line(start=col1[0], end=col3[1],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[1], end=col3[0],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col3[0:2] ).set_color(LIGHT_BROWN) )
                ...
                self.play(  FadeToColor(b2[0],YELLOW_D),
                            FadeToColor(b2[1],WHITE),
                            FadeToColor(b2[2],BLUE_D),
                            FadeToColor(b2[3],WHITE),
                            FadeToColor(b2[4],BLUE_D),

                            FadeToColor(col1[0],YELLOW_D),FadeToColor(col3[0],BLUE_D),
                            FadeToColor(col1[1],BLUE_D),  FadeToColor(col3[1],YELLOW_D),
                        )
        ...
        #SHOW b3
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[0], end=col4[1],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[1], end=col4[0],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col4[0:2] ).set_color(LIGHT_BROWN) )
                ...
                self.play(  FadeToColor(b3[0],YELLOW_D),
                            FadeToColor(b3[1],WHITE),
                            FadeToColor(b3[2],BLUE_D),
                            FadeToColor(b3[3],WHITE),
                            FadeToColor(b3[4],BLUE_D),

                            FadeToColor(col1[0],YELLOW_D),FadeToColor(col4[0],BLUE_D),
                            FadeToColor(col1[1],BLUE_D),  FadeToColor(col4[1],YELLOW_D),
                        )
        ...
        #SHOW b4
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[0], end=col5[1],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[1], end=col5[0],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col5[0:2] ).set_color(LIGHT_BROWN) )
                ...
                self.play(  FadeToColor(b4[0],YELLOW_D),
                            FadeToColor(b4[1],WHITE),
                            FadeToColor(b4[2],BLUE_D),
                            FadeToColor(b4[3],WHITE),
                            FadeToColor(b4[4],BLUE_D),

                            FadeToColor(col1[0],YELLOW_D),FadeToColor(col5[0],BLUE_D),
                            FadeToColor(col1[1],BLUE_D),  FadeToColor(col5[1],YELLOW_D),
                        )
        ...
        #SHOW c1
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[1], end=col2[2],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[2], end=col2[1],buff=0.1).set_color(BLUE_D) )

                rectver.generate_target()
                rectver.target.become( SurroundingRectangle( col1[1:3] ).set_color(LIGHT_BROWN) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col2[1:3] ).set_color(LIGHT_BROWN) )
                ...
                self.play(  FadeToColor(c1[0],YELLOW_D),
                            FadeToColor(c1[1],WHITE),
                            FadeToColor(c1[2],BLUE_D),
                            FadeToColor(c1[3],WHITE),
                            FadeToColor(c1[4],BLUE_D),

                            FadeToColor(col1[1],YELLOW_D),FadeToColor(col2[1],BLUE_D),
                            FadeToColor(col1[2],BLUE_D),  FadeToColor(col2[2],YELLOW_D),
                        )
        ...
        #SHOW c2
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[1], end=col3[2],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[2], end=col3[1],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col3[1:3] ).set_color(LIGHT_BROWN) )
                ...
                self.play(  FadeToColor(c2[0],YELLOW_D),
                            FadeToColor(c2[1],WHITE),
                            FadeToColor(c2[2],BLUE_D),
                            FadeToColor(c2[3],WHITE),
                            FadeToColor(c2[4],BLUE_D),

                            FadeToColor(col1[1],YELLOW_D),FadeToColor(col3[1],BLUE_D),
                            FadeToColor(col1[2],BLUE_D),  FadeToColor(col3[2],YELLOW_D),
                        )
        ...
        #SHOW c3
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[1], end=col4[2],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[2], end=col4[1],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col4[1:3] ).set_color(LIGHT_BROWN) )
                ...
                self.play(  FadeToColor(c3[0],YELLOW_D),
                            FadeToColor(c3[1],WHITE),
                            FadeToColor(c3[2],BLUE_D),
                            FadeToColor(c3[3],WHITE),
                            FadeToColor(c3[4],BLUE_D),

                            FadeToColor(col1[1],YELLOW_D),FadeToColor(col4[1],BLUE_D),
                            FadeToColor(col1[2],BLUE_D),  FadeToColor(col4[2],YELLOW_D),
                )
        ...
        #SHOW c4
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[1], end=col5[2],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[2], end=col5[1],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col5[1:3] ).set_color(LIGHT_BROWN) )
                ...
                self.play(  FadeToColor(c4[0],YELLOW_D),
                            FadeToColor(c4[1],WHITE),
                            FadeToColor(c4[2],BLUE_D),
                            FadeToColor(c4[3],WHITE),
                            FadeToColor(c4[4],BLUE_D),

                            FadeToColor(col1[1],YELLOW_D),FadeToColor(col5[1],BLUE_D),
                            FadeToColor(col1[2],BLUE_D),  FadeToColor(col5[2],YELLOW_D),
                        )
        ...
        #SHOW d1
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[2], end=col2[3],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[3], end=col2[2],buff=0.1).set_color(BLUE_D) )

                rectver.generate_target()
                rectver.target.become( SurroundingRectangle( col1[2:4] ).set_color(LIGHT_BROWN) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col2[2:4] ).set_color(LIGHT_BROWN) )
                ...
                self.play(  FadeToColor(d1[0],YELLOW_D),
                            FadeToColor(d1[1],WHITE),
                            FadeToColor(d1[2],BLUE_D),
                            FadeToColor(d1[3],WHITE),
                            FadeToColor(d1[4],BLUE_D),

                            FadeToColor(col1[2],YELLOW_D),FadeToColor(col2[2],BLUE_D),
                            FadeToColor(col1[3],BLUE_D),  FadeToColor(col2[3],YELLOW_D), **play_kw_fast
                        )
        ...
        #SHOW d2
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[2], end=col3[3],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[3], end=col3[2],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col3[2:4] ).set_color(LIGHT_BROWN) )
                ...
                self.play(  FadeToColor(d2[0],YELLOW_D),
                            FadeToColor(d2[1],WHITE),
                            FadeToColor(d2[2],BLUE_D),
                            FadeToColor(d2[3],WHITE),
                            FadeToColor(d2[4],BLUE_D),

                            FadeToColor(col1[2],YELLOW_D),FadeToColor(col3[2],BLUE_D),
                            FadeToColor(col1[3],BLUE_D),  FadeToColor(col3[3],YELLOW_D), **play_kw_fast
                        )
        ...
        #SHOW d3
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[2], end=col4[3],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[3], end=col4[2],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col4[2:4] ).set_color(LIGHT_BROWN) )
                ...
                self.play(  FadeToColor(d3[0],YELLOW_D),
                            FadeToColor(d3[1],WHITE),
                            FadeToColor(d3[2],BLUE_D),
                            FadeToColor(d3[3],WHITE),
                            FadeToColor(d3[4],BLUE_D),

                            FadeToColor(col1[2],YELLOW_D),FadeToColor(col4[2],BLUE_D),
                            FadeToColor(col1[3],BLUE_D),  FadeToColor(col4[3],YELLOW_D), **play_kw_fast
                        )
        ...
        #SHOW d4
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[2], end=col5[3],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[3], end=col5[2],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col5[2:4] ).set_color(LIGHT_BROWN) )
                ...
                self.play(  FadeToColor(d4[0],YELLOW_D),
                            FadeToColor(d4[1],WHITE),
                            FadeToColor(d4[2],BLUE_D),
                            FadeToColor(d4[3],WHITE),
                            FadeToColor(d4[4],BLUE_D),

                            FadeToColor(col1[2],YELLOW_D),FadeToColor(col5[2],BLUE_D),
                            FadeToColor(col1[3],BLUE_D),  FadeToColor(col5[3],YELLOW_D), **play_kw_fast
                        )
        ...
        #SHOW e1
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[3], end=col2[4],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[4], end=col2[3],buff=0.1).set_color(BLUE_D) )

                rectver.generate_target()
                rectver.target.become( SurroundingRectangle( col1[3:5] ).set_color(LIGHT_BROWN) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col2[3:5] ).set_color(LIGHT_BROWN) )
                ...
                self.play(  FadeToColor(e1[0],YELLOW_D),
                            FadeToColor(e1[1],WHITE),
                            FadeToColor(e1[2],BLUE_D),
                            FadeToColor(e1[3],WHITE),
                            FadeToColor(e1[4],BLUE_D),

                            FadeToColor(col1[3],YELLOW_D),FadeToColor(col2[3],BLUE_D),
                            FadeToColor(col1[4],BLUE_D),  FadeToColor(col2[4],YELLOW_D), **play_kw_fast
                        )
        ...
        #SHOW e2
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[3], end=col3[4],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[4], end=col3[3],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col3[3:5] ).set_color(LIGHT_BROWN) )
                ...
                self.play(  FadeToColor(e2[0],YELLOW_D),
                            FadeToColor(e2[1],WHITE),
                            FadeToColor(e2[2],BLUE_D),
                            FadeToColor(e2[3],WHITE),
                            FadeToColor(e2[4],BLUE_D),

                            FadeToColor(col1[3],YELLOW_D),FadeToColor(col3[3],BLUE_D),
                            FadeToColor(col1[4],BLUE_D),  FadeToColor(col3[4],YELLOW_D), **play_kw_fast
                        )
        ...
        #SHOW e3
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[3], end=col4[4],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[4], end=col4[3],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col4[3:5] ).set_color(LIGHT_BROWN) )
        ...
        #SHOW e4
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[3], end=col5[4],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[4], end=col5[3],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col5[3:5] ).set_color(LIGHT_BROWN) )
        ...
        #SHOW f1
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[4], end=col2[5],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[5], end=col2[4],buff=0.1).set_color(BLUE_D) )

                rectver.generate_target()
                rectver.target.become( SurroundingRectangle( col1[4:6] ).set_color(LIGHT_BROWN) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col2[4:6] ).set_color(LIGHT_BROWN) )
                ...
                self.play(  FadeToColor(f1[0],YELLOW_D),
                            FadeToColor(f1[1],WHITE),
                            FadeToColor(f1[2],BLUE_D),
                            FadeToColor(f1[3],WHITE),
                            FadeToColor(f1[4],BLUE_D),

                            FadeToColor(col1[4],YELLOW_D),FadeToColor(col2[4],BLUE_D),
                            FadeToColor(col1[5],BLUE_D),  FadeToColor(col2[5],YELLOW_D), **play_kw_fast
                        )
        ...
        #SHOW f2
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[4], end=col3[5],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[5], end=col3[4],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col3[4:6] ).set_color(LIGHT_BROWN) )
        ...
        #SHOW f3
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[4], end=col4[5],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[5], end=col4[4],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col4[4:6] ).set_color(LIGHT_BROWN) )
        ...
        #SHOW f4
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[4], end=col5[5],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[5], end=col5[4],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col5[4:6] ).set_color(LIGHT_BROWN) )
        ...
        #SHOW g1
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[5], end=col2[6],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[6], end=col2[5],buff=0.1).set_color(BLUE_D) )

                rectver.generate_target()
                rectver.target.become( SurroundingRectangle( col1[5:7] ).set_color(LIGHT_BROWN) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col2[5:7] ).set_color(LIGHT_BROWN) )
                ...
                self.play(  FadeToColor(g1[0],YELLOW_D),
                            FadeToColor(g1[1],WHITE),
                            FadeToColor(g1[2],BLUE_D),
                            FadeToColor(g1[3],WHITE),
                            FadeToColor(g1[4],BLUE_D),

                            FadeToColor(col1[5],YELLOW_D),FadeToColor(col2[5],BLUE_D),
                            FadeToColor(col1[6],BLUE_D),  FadeToColor(col2[6],YELLOW_D), **play_kw_fast
                        )
        ...
        #SHOW g2
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[5], end=col3[6],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[6], end=col3[5],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col3[5:7] ).set_color(LIGHT_BROWN) )
        ...
        #SHOW g3
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[5], end=col4[6],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[6], end=col4[5],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col4[5:7] ).set_color(LIGHT_BROWN) )
        ...
        #SHOW g4
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[5], end=col5[6],buff=0.1).set_color(YELLOW_D) )
                crl2.target.become( Line(start=col1[6], end=col5[5],buff=0.1).set_color(BLUE_D) )

                recthor.generate_target()
                recthor.target.become( SurroundingRectangle( col5[5:7] ).set_color(LIGHT_BROWN) )
