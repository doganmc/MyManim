...
class E_EX1_ENG(Scene):
    def construct(self):
                ...
                # self.wait(1.5)
                # self.play( FadeIn( poly1[1].set_color(GREY_B) ) )
                # self.wait(1.5)
                ################## ##################

                self.play( FadeToColor( poly1[4],BLUE_C ), FadeToColor( poly1[7],YELLOW_C ), FadeToColor( poly1[10],YELLOW_C ), FadeToColor( poly1[13],PINK ) )
        ...
        # CREATE THE ROUTH TABLE
                ...
                col1[4].set_color(TEAL_C)

                first_two_rows = VGroup( col1[0:2], col2[0:2], col3[0:2] )

                first_three_rows = VGroup( col1[0:3], col2[0:3], col3[0:3] )

                first_four_rows = VGroup ( col1[0:4], col2[0:4], col3[0:4] )

                first_five_rows = VGroup ( col1[0:5], col2[0:5], col3[0:5] )
                ...
                self.play( dota4.animate.move_to(n_line.n2p(1)), **play_kw_fast )
                ...
                self.play( dota3.animate.move_to(n_line.n2p(2)), **play_kw_fast )
        ...
        #SHOW b3
                ...
                # # # # self.play(Restore(first_two_rows), run_time=restore_time)
                # # # # self.wait(1)
                ...
                self.play( dotb1.animate.move_to(n_line.n2p(1)), **play_kw_fast )
        ...
        #SHOW d3
                ...
                self.play( dotd1.animate.move_to(n_line.n2p(5)),**play_kw_fast )
