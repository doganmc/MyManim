...
class F_EX2_ENG(Scene):
        ...
        # EXAMPLE 2 OPENING SCENE
                ...
                self.play( FadeToColor( poly1[1],BLUE_C ),FadeToColor( poly1[4],BLUE_C ) , FadeToColor( poly1[7],YELLOW_C ), FadeToColor( poly1[10],YELLOW_C ), FadeToColor( poly1[13],RED ), FadeToColor( poly1[16],PINK ) )
            ...
            # CREATE THE ROUTH TABLE
                ...
                col1[2].set_color(GREEN)
                col1[3].set_color(ORANGE)
                ...
                crl1 = Line(start=col1[0], end=col2[1],buff=0.1).set_color(GREY_BROWN)
                crl2 = Line(start=col1[1], end=col2[0],buff=0.1).set_color(GREY_B)
                ...
                self.play( dota5.animate.move_to(n_line.n2p(2)), **play_kw_fast )
                ...
                self.play( dota4.animate.move_to(n_line.n2p(4)), **play_kw_fast )
        ...
        # SHOW b1
                ...
                self.play(  FadeToColor(b1[0],GREY_BROWN),
                            FadeToColor(b1[1],WHITE),
                            FadeToColor(b1[2],GREY_B),
                            FadeToColor(b1[3],WHITE),
                            FadeToColor(b1[4],GREY_B),

                            FadeToColor(col1[0],GREY_BROWN),FadeToColor(col2[0],GREY_B),
                            FadeToColor(col1[1],GREY_B),  FadeToColor(col2[1],GREY_BROWN),**play_kw_fast
                        )
        ...
        # SHOW b2
                ...
                crl1.target.become( Line(start=col1[0], end=col3[1],buff=0.1).set_color(GREY_BROWN) )
                crl2.target.become( Line(start=col1[1], end=col3[0],buff=0.1).set_color(GREY_B) )
                ...
                self.play(  FadeToColor(b2[0],GREY_BROWN),
                            FadeToColor(b2[1],WHITE),
                            FadeToColor(b2[2],GREY_B),
                            FadeToColor(b2[3],WHITE),
                            FadeToColor(b2[4],GREY_B),

                            FadeToColor(col1[0],GREY_BROWN),FadeToColor(col3[0],GREY_B),
                            FadeToColor(col1[1],GREY_B),  FadeToColor(col3[1],GREY_BROWN),**play_kw_fast
                        )
        ...
        #SHOW b3
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[0], end=col4[1],buff=0.1).set_color(GREY_BROWN) )
                crl2.target.become( Line(start=col1[1], end=col4[0],buff=0.1).set_color(GREY_B) )
                ...
                self.play(  FadeToColor(b3[0],GREY_BROWN),
                            FadeToColor(b3[1],WHITE),
                            FadeToColor(b3[2],GREY_B),
                            FadeToColor(b3[3],WHITE),
                            FadeToColor(b3[4],GREY_B),

                            FadeToColor(col1[0],GREY_BROWN),FadeToColor(col4[0],GREY_B),
                            FadeToColor(col1[1],GREY_B),  FadeToColor(col4[1],GREY_BROWN),**play_kw_fast
                        )
        ...
        #SHOW b4
                ...
                self.play( dotb1.animate.move_to(n_line.n2p(4)), **play_kw_fast )
        ...
        #SHOW c1
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[1], end=col2[2],buff=0.1).set_color(GREY_BROWN) )
                crl2.target.become( Line(start=col1[2], end=col2[1],buff=0.1).set_color(GREY_B) )
                ...
                self.play(  FadeToColor(c1[0],GREY_BROWN),
                            FadeToColor(c1[1],WHITE),
                            FadeToColor(c1[2],GREY_B),
                            FadeToColor(c1[3],WHITE),
                            FadeToColor(c1[4],GREY_B),

                            FadeToColor(col1[1],GREY_BROWN),FadeToColor(col2[1],GREY_B),
                            FadeToColor(col1[2],GREY_B),  FadeToColor(col2[2],GREY_BROWN),**play_kw_fast
                        )
        ...
        #SHOW c2
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[1], end=col3[2],buff=0.1).set_color(GREY_BROWN) )
                crl2.target.become( Line(start=col1[2], end=col3[1],buff=0.1).set_color(GREY_B) )
                ...
                self.play(  FadeToColor(c2[0],GREY_BROWN),
                            FadeToColor(c2[1],WHITE),
                            FadeToColor(c2[2],GREY_B),
                            FadeToColor(c2[3],WHITE),
                            FadeToColor(c2[4],GREY_B),

                            FadeToColor(col1[1],GREY_BROWN),FadeToColor(col3[1],GREY_B),
                            FadeToColor(col1[2],GREY_B),  FadeToColor(col3[2],GREY_BROWN),**play_kw_fast
                        )
        ...
        #SHOW c3
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[1], end=col4[2],buff=0.1).set_color(GREY_BROWN) )
                crl2.target.become( Line(start=col1[2], end=col4[1],buff=0.1).set_color(GREY_B) )
                ...
                self.play(  FadeToColor(c3[0],GREY_BROWN),
                            FadeToColor(c3[1],WHITE),
                            FadeToColor(c3[2],GREY_B),
                            FadeToColor(c3[3],WHITE),
                            FadeToColor(c3[4],GREY_B),

                            FadeToColor(col1[1],GREY_BROWN),FadeToColor(col4[1],GREY_B),
                            FadeToColor(col1[2],GREY_B),  FadeToColor(col4[2],GREY_BROWN),**play_kw_fast
                        )
        ...
        #SHOW c4
                ...
                self.play(FadeIn(dotc1, scale=0.5), Write(c1q) ,**play_kw_fast)
        ...
        #SHOW d1
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[2], end=col2[3],buff=0.1).set_color(GREY_BROWN) )
                crl2.target.become( Line(start=col1[3], end=col2[2],buff=0.1).set_color(GREY_B) )
                ...
                self.play(  FadeToColor(d1[0],GREY_BROWN),
                            FadeToColor(d1[1],WHITE),
                            FadeToColor(d1[2],GREY_B),
                            FadeToColor(d1[3],WHITE),
                            FadeToColor(d1[4],GREY_B),

                            FadeToColor(col1[2],GREY_BROWN),FadeToColor(col2[2],GREY_B),
                            FadeToColor(col1[3],GREY_B),  FadeToColor(col2[3],GREY_BROWN),**play_kw_fast
                        )
        ...
        #SHOW d2
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[2], end=col3[3],buff=0.1).set_color(GREY_BROWN) )
                crl2.target.become( Line(start=col1[3], end=col3[2],buff=0.1).set_color(GREY_B) )
                ...
                self.play(  FadeToColor(d2[0],GREY_BROWN),
                            FadeToColor(d2[1],WHITE),
                            FadeToColor(d2[2],GREY_B),
                            FadeToColor(d2[3],WHITE),
                            FadeToColor(d2[4],GREY_B),

                            FadeToColor(col1[2],GREY_BROWN),FadeToColor(col3[2],GREY_B),
                            FadeToColor(col1[3],GREY_B),  FadeToColor(col3[3],GREY_BROWN),**play_kw_fast
                        )
        ...
        #SHOW d3
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[2], end=col4[3],buff=0.1).set_color(GREY_BROWN) )
                crl2.target.become( Line(start=col1[3], end=col4[2],buff=0.1).set_color(GREY_B) )
                ...
                self.play(  FadeToColor(d3[0],GREY_BROWN),
                            FadeToColor(d3[1],WHITE),
                            FadeToColor(d3[2],GREY_B),
                            FadeToColor(d3[3],WHITE),
                            FadeToColor(d3[4],GREY_B),

                            FadeToColor(col1[2],GREY_BROWN),FadeToColor(col4[2],GREY_B),
                            FadeToColor(col1[3],GREY_B),  FadeToColor(col4[3],GREY_BROWN),**play_kw_fast
                        )
        ...
        #SHOW d4
                ...
                self.play(FadeIn(dotd1, scale=0.5), Write(d1q),**play_kw_fast)
        ...
        #SHOW e1
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[3], end=col2[4],buff=0.1).set_color(GREY_BROWN) )
                crl2.target.become( Line(start=col1[4], end=col2[3],buff=0.1).set_color(GREY_B) )
                ...
                self.play(  FadeToColor(e1[0],GREY_BROWN),
                            FadeToColor(e1[1],WHITE),
                            FadeToColor(e1[2],GREY_B),
                            FadeToColor(e1[3],WHITE),
                            FadeToColor(e1[4],GREY_B),

                            FadeToColor(col1[3],GREY_BROWN),FadeToColor(col2[3],GREY_B),
                            FadeToColor(col1[4],GREY_B),  FadeToColor(col2[4],GREY_BROWN),**play_kw_fast
                        )
        ...
        #SHOW e2
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[3], end=col3[4],buff=0.1).set_color(GREY_BROWN) )
                crl2.target.become( Line(start=col1[4], end=col3[3],buff=0.1).set_color(GREY_B) )
                ...
                self.play(  FadeToColor(e2[0],GREY_BROWN),
                            FadeToColor(e2[1],WHITE),
                            FadeToColor(e2[2],GREY_B),
                            FadeToColor(e2[3],WHITE),
                            FadeToColor(e2[4],GREY_B),

                            FadeToColor(col1[3],GREY_BROWN),FadeToColor(col3[3],GREY_B),
                            FadeToColor(col1[4],GREY_B),  FadeToColor(col3[4],GREY_BROWN),**play_kw_fast
                        )
        ...
        #SHOW e3
                ...
                crl1.generate_target()
                crl2.generate_target()
                crl1.target.become( Line(start=col1[3], end=col4[4],buff=0.1).set_color(GREY_BROWN) )
                crl2.target.become( Line(start=col1[4], end=col4[3],buff=0.1).set_color(GREY_B) )
                ...
                self.play(  FadeToColor(e3[0],GREY_BROWN),
                            FadeToColor(e3[1],WHITE),
                            FadeToColor(e3[2],GREY_B),
                            FadeToColor(e3[3],WHITE),
                            FadeToColor(e3[4],GREY_B),

                            FadeToColor(col1[3],GREY_BROWN),FadeToColor(col4[3],GREY_B),
                            FadeToColor(col1[4],GREY_B),  FadeToColor(col4[4],GREY_BROWN),**play_kw_fast
                        )
        ...
        #SHOW e4
                ...
                self.play( dote1.animate.move_to(n_line.n2p(2)), **play_kw_fast )
                ...
                while val < 12.26:
                    ...
                    self.add(dotd1)
                    self.add(vt)
                    self.wait(0.001) # this 'self.wait' should not be commented out.
